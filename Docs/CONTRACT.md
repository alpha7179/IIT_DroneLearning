...
| 2026-03-09 | 수치 불일치 확인 | Pursuer AGENTS.md와 차이 발견 — 재합의 필요 | 이재왕 |

> Week 1 팀 회의에서 수치 확정 후 이 표에 기록한다.

### ⚠️ 재합의 필요 항목 (2026-03-09 기준)

Pursuer 팀 `IIT_DroneLearning/AGENTS.md`와 아래 수치가 다름:

| 항목 | 이 문서 | Pursuer AGENTS.md |
|---|---|---|
| Catch 거리/연속 스텝 | `d < 2.0m, k=3` | `d < 1.5m, k=5` |
| Timeout | `20s` | `25s` |

→ Week 1 팀 회의에서 합의 후 통일 필요
